        ...
        <div className='banner'>
            ...
            <div className='login-wrap'>
                ...
                <div className='login-items'>
                    <input onChange={(e) => setEmail(e.target.value)} value={Email} type='email' name='email' id='email' placeholder='Email' class="form-control"/>
                </div>
                <div className='login-items'>
                    <input onChange={(e) => setMobile(e.target.value)} value={Mobile} type='number' name='mobile' id='mobile' placeholder='Mobile' className='form-control'/>
                </div>
                <div className="login-items">
